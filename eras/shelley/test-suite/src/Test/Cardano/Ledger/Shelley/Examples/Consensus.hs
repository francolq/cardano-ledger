...
import Test.Cardano.Ledger.Shelley.Generator.EraGen (mkDummyHash)
    ...
    blockHeaderBody =
      BHBody
        { bheaderBlockNo = BlockNo 3,
          ...
          bheaderPrev = BlockHash (HashHeader (mkDummyHash 2)),
...
exampleHashHeader _ = coerce $ mkDummyHash @(HASH (EraCrypto era)) 0
