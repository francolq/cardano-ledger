...
module Test.Cardano.Ledger.Binary.Arbitrary (QC (..), genVersion) where
...
-- TODO: Move this somewhere where it can be used at a larger scale
--
-- This comes from an unmerged QuickCheck PR: https://github.com/nick8325/quickcheck/pull/333
data QC = QC
